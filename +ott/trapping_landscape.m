function [structureOutput]=trapping_landscape(index_range,size_range_rad,system_parameters)
% trapping_landscape.m: Generates a trapping landscape along the beam
%                        propagaing axis.
%
% USAGE:
% [structureOutput]=trapping_landscape(index_range,size_range_rad,system_p
% arameters)
%
% VARIABLES:
